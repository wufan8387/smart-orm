...
public class LessThanEqualOperation extends WhereOperation {
    ...
    public LessThanEqualOperation(String table, String property, Object value) {
        super(WhereType.NONE, table, property);
        this.value = value;
    }
    
    public LessThanEqualOperation(TableInfo table, String property, Object value) {
        super(WhereType.NONE, table, property);
        this.value = value;
    }
    ...
    public LessThanEqualOperation(WhereType whereType, String table, String property, Object value) {
        super(whereType, table, property);
        this.value = value;
    }
    
    public LessThanEqualOperation(WhereType whereType, TableInfo table, String property, Object value) {
        super(whereType, table, property);
        this.value = value;
    }
