...
//                    sb.append(String.op(" (%s) ,", text));
//                } else {
//                    sb.append(String.op(" (%s) REL_AS `%s` ,", text, alias));
//                }
//            } else {
//
...
//
//                if (StringUtils.isEmpty(alias)) {
//                    sb.append(String.op(" `%s`.`%s` ,", prefix, text));
//                } else {
//                    sb.append(String.op(" `%s`.`%s` REL_AS `%s` ,", prefix, text, alias));
//                }
//            }
//
//
...
//        sb.append(" ");
//
//        return String.op(EXPRESSION, sb.toString());
//
//
//    }
//
