...
public class Facade {
    ...
    public static <T extends Model<T>> EqualOperation<T> equal(Class<T> cls, Getter<T> property, Object value,
            WhereType whereType) {
        return new EqualOperation<>(whereType, property, value);
    }
    ...
    // not equal
    public static <T extends Model<T>> NotEqualOperation<T> notEqual(Getter<T> property, Object value,
            WhereType whereType) {
        return new NotEqualOperation<>(whereType, property, value);
    }

    public static <T extends Model<T>> NotEqualOperation<T> notEqual(Class<T> cls, Getter<T> property, Object value,
            WhereType whereType) {
        return new NotEqualOperation<>(whereType, property, value);
    }
    ...
    // between
    public static <T extends Model<T>> BetweenOperation<T> between(Getter<T> property, Object value1, Object value2,
            WhereType whereType) {
        return new BetweenOperation<>(whereType, property, value1, value2);
    }

    public static <T extends Model<T>> BetweenOperation<T> between(Class<T> cls, Getter<T> property, Object value1,
    ...
    public static <T extends Model<T>> LikeOperation<T> like(Class<T> cls, Getter<T> property, String value,
            WhereType whereType) {
        return new LikeOperation<>(whereType, property, value);
    }
    ...
    // great than
    public static <T extends Model<T>> GreatThanOperation<T> greatThan(Getter<T> property, Object value,
            WhereType whereType) {
        return new GreatThanOperation<>(whereType, property, value);
    }

    public static <T extends Model<T>> GreatThanOperation<T> greatThan(Class<T> cls, Getter<T> property, Object value,
            WhereType whereType) {
        return new GreatThanOperation<>(whereType, property, value);
    }
    ...
    // less than
    public static <T extends Model<T>> LessThanOperation<T> lessThan(Getter<T> property, Object value,
            WhereType whereType) {
        return new LessThanOperation<>(whereType, property, value);
    }

    public static <T extends Model<T>> LessThanOperation<T> lessThan(Class<T> cls, Getter<T> property, Object value,
            WhereType whereType) {
        return new LessThanOperation<>(whereType, property, value);
    }
    ...
    // greate than equal
    public static <T extends Model<T>> GreatThanEqualOperation<T> greateThanEqual(Getter<T> property, Object value,
            WhereType whereType) {
        return new GreatThanEqualOperation<>(whereType, property, value);
    }

    public static <T extends Model<T>> GreatThanEqualOperation<T> greateThanEqual(Class<T> cls, Getter<T> property,
    ...
    // less than equal
    public static <T extends Model<T>> LessThanEqualOperation<T> lessThanEqual(Getter<T> property, Object value,
            WhereType whereType) {
        return new LessThanEqualOperation<T>(whereType, property, value);
    }

    public static <T extends Model<T>> LessThanEqualOperation<T> lessThanEqual(Class<T> cls, Getter<T> property,
            Object value, WhereType whereType) {
        return new LessThanEqualOperation<T>(whereType, property, value);
    }
    ...
    // exists
    public static <T extends Model<T>> ExistsOperation<T> exists(Getter<T> property, Object value,
            WhereType whereType) {
    ...
    // not exists
    public static <T extends Model<T>> NotExistsOperation<T> notExists(Getter<T> property, Object value,
            WhereType whereType) {
