...
public class SimpleExecutor implements Executor {
    ...
    @Override
    public <T> void executeQuery(Connection connection, String sql, ResultHandler<T> handler, Object... args) {
    ...
    @Override
    public <T> int insert(Connection connection, String sql, ResultHandler<T> handler, int autoGeneratedKeys, Object...
            args) {
    ...
    @Override
    public <T> void execute(Connection connection, String sql, ResultHandler<T> handler) {
