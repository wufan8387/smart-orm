...
public class SimpleExecutor implements Executor {
    ...
    @Override
    public <T> void executeQuery(Connection connection, ResultHandler<T> handler, String sql, Object... args) {
    ...
    @Override
    public CachedRowSet executeQuery(Connection connection, String sql, Object... args) {
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            setParameters(ps, args);
            ps.execute();
    ...
    @Override
    public <T> int insert(Connection connection, ResultHandler<T> handler, String sql, int autoGeneratedKeys, Object... args) {
    ...
    @Override
    public int delete(Connection connection, String sql, Object... args) {
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            setParameters(ps, args);
            return ps.executeUpdate();
        } catch (SQLException ex) {
    ...
    @Override
    public <T> void execute(Connection connection, ResultHandler<T> handler, String sql) {
    ...
    private void setParameters(PreparedStatement ps, Object... args) throws SQLException {
        for (int i = 0, n = args.length; i < n; i++) {
            Object arg = args[i];
            parameterTypeHandler.handle(ps, i, arg);
        }
    }
